...
import { ConvocatoriaThresholdsSectionComponent } from './convocatoria-thresholds-section.component';

async function create(aptoMin = 70, revisarMin = 50) {
  await TestBed.configureTestingModule({
    imports: [ConvocatoriaThresholdsSectionComponent],
    providers: [provideTranslateService({ lang: 'es' })],
  }).compileComponents();

  const fixture = TestBed.createComponent(ConvocatoriaThresholdsSectionComponent);
  fixture.componentRef.setInput('aptoMin', aptoMin);
  fixture.componentRef.setInput('revisarMin', revisarMin);
  return fixture.componentInstance;
}

describe('ConvocatoriaThresholdsSectionComponent', () => {
