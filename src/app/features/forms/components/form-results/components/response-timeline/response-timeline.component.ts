...
// Mantener en sync manualmente con --ff-primary en styles.scss — ApexCharts no
// puede resolver custom properties CSS al momento de construir las opciones.
...
@Component({
  ...
  imports: [TranslatePipe, NgApexchartsModule, EmptyStateComponent, TabsComponent],
...
export class ResponseTimelineComponent {
  ...
  protected readonly chart: ApexChart = { type: 'line', height: 240, toolbar: { show: false } };
